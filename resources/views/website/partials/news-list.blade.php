...
<div class="flex flex-wrap items-center justify-between gap-4 mb-8">
    ...
    <a href="{{ localized_route('news.index') }}"
        class="news-clear-link text-sm font-bold text-slate-500 hover:text-primary transition-colors">مسح الكل</a>
</div>
@endif
...
<div class="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-6">
    ...
    <div class="col-span-full text-center py-16 text-slate-500 dark:text-slate-400">
        ...
        <a href="{{ localized_route('news.index') }}" class="news-clear-link inline-block mt-4 text-primary font-bold hover:underline">عرض جميع الأخبار</a>
    </div>
    @endforelse
</div>
